    ...
    <el-dialog :title="isEdit ? '编辑推广页面关键字' : '新增推广页面关键字'" :visible.sync="dialogFormVisible" width="800px">
      <el-form :model="editData" ref="ruleForm" label-width="120px" style="margin-top: 20px;">
        ...
        <el-form-item label="说明">
          <el-input v-model="editData.info" type="text" style="width: 60%" clearable placeholder="请输入"></el-input>
        </el-form-item>
        <el-form-item label="内容">
          <el-input v-model="editData.content" type="text" style="width: 60%" clearable placeholder="请输入"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import { configList, configInfo, auditConfig } from '@/api/popularize'
